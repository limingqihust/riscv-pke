...
int sem_new(int n){
  return do_user_call(SYS_user_sem_new, (uint64)n, 0, 0, 0, 0, 0, 0);
}
void sem_P(int n){
  do_user_call(SYS_user_sem_P, (uint64)n, 0, 0, 0, 0, 0, 0);
}
void sem_V(int n){
  do_user_call(SYS_user_sem_V, (uint64)n, 0, 0, 0, 0, 0, 0);
}